...
export default async function SimilarGames({ gameIds }) {
  ...
  const similarGames = await fetchGameData(
    ...
    where id = (${gameIds}) & screenshots != null & cover != null & involved_companies != null & version_parent = null & first_release_date != null & keywords != (2004, 24124, 25522, 33402, 1603, 4472) & category = (0, 8, 9, 10); 
    limit 20; 
