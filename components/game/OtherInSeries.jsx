...
export default async function OtherInSeries({ collectionId, gameId }) {
  ...
  const collectionGames = await fetchGameData(
    ...
    where id = (${collectionIdArr}) & id != ${gameId} & screenshots != null & involved_companies != null & version_parent = null & first_release_date != null & keywords != (2004, 24124, 25522, 33402, 1603, 4472) & category = (0, 4, 8, 9, 10); 
    limit 20; 
